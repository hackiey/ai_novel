...
export default function AdminPage() {
  ...
  if (user?.role !== "admin") {
    return <div className="p-8 text-center text-gray-500">无权访问</div>;
  }
            ...
            {editingId === g._id ? (
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button onClick={() => handleUpdate(g._id)} className="text-xs text-teal-600 hover:underline">保存</button>
