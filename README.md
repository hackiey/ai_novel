...
> **AI Creator** 不是又一个"AI 聊天 + 编辑器"。它内置一位真正理解你故事的 AI 写作搭档——管理角色和设定、智能续写章节、在创作知识库中语义搜索、记住你的创作偏好。像一个经验丰富的编辑伙伴，而不是一个只会接话的聊天机器人。
...
- [x] **Skill 系统** —— 从网文论坛/教程文档中提取写作方法论沉淀为可复用的 Skill，AI 在创作时按需调用；支持按项目/世界观自定义启用范围
