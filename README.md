...
> **AI Creator** 不是又一个"AI 聊天 + 编辑器"。它内置一位真正理解你故事的 AI 写作搭档——管理角色和设定、智能续写章节、在创作知识库中语义搜索、记住你的创作偏好。配套 **391+ 内置写作 Skill**（开篇钩子、反派塑造、爽点设计、节奏控制等网文方法论），AI 按需调用，比凭直觉答更靠谱。像一个经验丰富的编辑伙伴，而不是一个只会接话的聊天机器人。
